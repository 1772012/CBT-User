...
/**
 * VideoquestionId generated by hbm2java
 */
@Embeddable
public class VideoquestionId  implements java.io.Serializable {
    ...
    public VideoquestionId() {
    }

    public VideoquestionId(int id, String questionDbId, String subTestId) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VideoquestionId) ) return false;
		 VideoquestionId castOther = ( VideoquestionId ) other; 

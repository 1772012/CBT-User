...
/**
 * AudioquestionId generated by hbm2java
 */
@Embeddable
public class AudioquestionId  implements java.io.Serializable {
    ...
    public AudioquestionId() {
    }

    public AudioquestionId(int id, String questionDbId, String subTestId) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AudioquestionId) ) return false;
		 AudioquestionId castOther = ( AudioquestionId ) other; 
